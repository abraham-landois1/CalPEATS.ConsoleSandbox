...
{
    public class FakeUserDbContext : IUserDbContext
    {
        public DbSet<UserLogin> UserLogins { get; set; } // user_login
        public DbSet<Version> Versions { get; set; } // _version

        public FakeUserDbContext()
        {
            _database = new FakeDatabaseFacade(new UserDbContext());

            UserLogins = new FakeDbSet<UserLogin>("UserName");
            Versions = new FakeDbSet<Version>("Schema");
